...
export class ApiService {
  ...
  createPatient(patientData: any, token: string): Observable<any> {
    return this.http.post(`${this.apiBaseUrl}/patients/`, patientData, {
      headers: this.buildAuthHeaders(token),
    });
  }

  getPatient(token: string): Observable<any> {
    return this.http.get(`${this.apiBaseUrl}/patients/`, {
      headers: this.buildAuthHeaders(token),
    });
  }
  ...
  uploadXray(file: File, patientId: string, token: string, modelName?: string): Observable<any> {
    ...
    return this.http.post(`${this.apiBaseUrl}/xray/upload`, formData, {
      headers: this.buildAuthHeaders(token),
    });
  }
  ...
  getAnalysis(analysisId: string, token: string): Observable<any> {
    return this.http.get(`${this.apiBaseUrl}/xray/${analysisId}`, {
      headers: this.buildAuthHeaders(token),
    });
  }

  getAllAnalyses(token: string): Observable<any> {
    return this.http.get(`${this.apiBaseUrl}/xray/`, {
      headers: this.buildAuthHeaders(token),
    });
  }
